...
public class SetRaceRouteFragment extends Fragment {      // zrobione na podstawie SetRouteActivity, przerobić ten kod aby działał na fragmencie!!

    public SetRaceRouteFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_set_race_route, container, false);

        this.mapView = view.findViewById(R.id.map_view);
        this.mapView.onCreate(savedInstanceState);
        this.setLongPressGestureHandler(mapView);

        this.resetRoute = view.findViewById(R.id.reset_route);
        this.setRoute = view.findViewById(R.id.set_route);
